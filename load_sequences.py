...
def process_fasta_loading(data_dir="suspects", fasta_files=None):
    """
...
process_fasta_loading()  # Uses default directory "suspects" and loads all .fasta files in it.  Make sure you have a folder called 'suspects' with .fasta files in it.
